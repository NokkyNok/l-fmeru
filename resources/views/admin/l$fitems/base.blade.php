...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="{{asset ('back/image/png')}}" sizes="16x16" href="{{asset ('back/plugins/images/favicon.png')}}">
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <!-- ============================================================== -->
                        <li class=" in">
                            <form method="GET" action="" role="search" class="app-search d-none d-md-block mr-3">
                                <input type="text" name="query" id="query" placeholder="Search..." class="form-control mt-0">
                                <a href="" class="active">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            ...
                            <a href="/"
                                class="btn btn-block btn-danger text-white" target="_blank">Back to site</a>
                        </li>
                    </ul>
        ...
        <div class="page-wrapper" style="min-height: 250px;">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="/" class="btn btn-primary btn-info text-lowercase" > </i></a>
                            </ol>
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer text-center"> 2021 L$FMeru services <a
                    href="https://avceil.com/">avceil.com</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset ('back/plugins/bower_components/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{asset ('back/plugins/bower_components/popper.js/dist/umd/popper.min.js')}}"></script>
    <script src="{{asset ('back/bootstrap/dist/js/bootstrap.min.js')}}"></script>
